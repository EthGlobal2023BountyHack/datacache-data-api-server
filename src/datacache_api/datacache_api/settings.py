"""
Django settings for datacache_api project.
...
SECRET_KEY = 'pr!uh@mf%9n0=ftpqqxeoukd3v*!3n$%l&l0-houeb+a8_k(+h'
...
ROOT_URLCONF = 'datacache_api.urls'
...
WSGI_APPLICATION = 'datacache_api.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'CLIENT': {
            ...
            'port': int(os.getenv("MONGODB_PORT", default=0)),
